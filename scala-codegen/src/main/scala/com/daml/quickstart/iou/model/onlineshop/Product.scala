  ...
  package OnlineShop {
    ...
    object Product extends ` lfdomainapi`.TemplateCompanion[Product] with _root_.scala.Function3[` lfdomainapi`.Primitive.Text, ` lfdomainapi`.Primitive.Int64, ` lfdomainapi`.Primitive.List[` lfdomainapi`.Primitive.ContractId[com.daml.quickstart.iou.model.OnlineShop.Reservation]], _root_.com.daml.quickstart.iou.model.OnlineShop.Product] {
      ...
      final implicit class `Product syntax`[+` ExOn`](private val id: ` ExOn`) extends _root_.scala.AnyVal {
        def exerciseProduct_DecrementInventory(actor: ` lfdomainapi`.Primitive.Party, choiceArgument: com.daml.quickstart.iou.model.OnlineShop.Product_DecrementInventory)(implicit ` exOn` : ` lfdomainapi`.encoding.ExerciseOn[` ExOn`, Product]): ` lfdomainapi`.Primitive.Update[` lfdomainapi`.Primitive.ContractId[com.daml.quickstart.iou.model.OnlineShop.Reservation]] = ` exercise`(actor, id, "Product_DecrementInventory", _root_.scala.Some(` lfdomainapi`.Value.encode(choiceArgument)));
        def exerciseProduct_DecrementInventory(actor: ` lfdomainapi`.Primitive.Party, reservation: com.daml.quickstart.iou.model.OnlineShop.Reservation)(implicit ` exOn` : ` lfdomainapi`.encoding.ExerciseOn[` ExOn`, Product]): ` lfdomainapi`.Primitive.Update[` lfdomainapi`.Primitive.ContractId[com.daml.quickstart.iou.model.OnlineShop.Reservation]] = exerciseProduct_DecrementInventory(actor, _root_.com.daml.quickstart.iou.model.OnlineShop.Product_DecrementInventory(reservation));
      ...
      override val consumingChoices: _root_.scala.collection.immutable.Set[` lfdomainapi`.Primitive.ChoiceId] = ` lfdomainapi`.Primitive.ChoiceId.subst(_root_.scala.collection.immutable.Set("Product_DecrementInventory", "Archive", "Product_ReservationCompleted", "Product_WithdrawReservation"));
